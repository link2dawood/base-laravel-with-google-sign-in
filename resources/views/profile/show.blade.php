                ...
                <div class="neuro-card neuro-fade-in">
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="mb-4">
                                <div class="d-flex align-items-center">
                                    <div class="neuro-security-icon bg-primary text-white me-3">
                                    ...
                                    <div>
                                        <div class="font-weight-medium text-primary">Password Security</div>
                                        <div class="text-muted small">Last changed: {{ $user->updated_at->format('M d, Y') }}</div>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="mb-4">
                                <div class="d-flex align-items-center">
                                    <div class="neuro-security-icon bg-success text-white me-3">
                                        <svg xmlns="http://www.w3.org/2000/svg" class="icon" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round"><path stroke="none" d="m0 0h24v24H0z" fill="none"/><path d="M3 7a2 2 0 0 1 2 -2h14a2 2 0 0 1 2 2v10a2 2 0 0 1 -2 2h-14a2 2 0 0 1 -2 -2v-10z"/><path d="m3 7l9 6l9 -6"/></svg>
                                    </div>
                                    <div>
                                        <div class="font-weight-medium text-success">Email Security</div>
                        ...
                        <div class="col-md-4">
                            <div class="mb-4">
                                <div class="d-flex align-items-center">
                                    <div class="neuro-security-icon {{ $user->google_id ? 'bg-info' : 'bg-secondary' }} text-white me-3">
                                        <svg xmlns="http://www.w3.org/2000/svg" class="icon" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round"><path stroke="none" d="m0 0h24v24H0z" fill="none"/><path d="M17.788 5.108A9 9 0 1 0 21 12h-8"/></svg>
                                    </div>
                                    <div>
                                        <div class="font-weight-medium {{ $user->google_id ? 'text-info' : 'text-secondary' }}">Google OAuth</div>
                                        <div class="text-muted small">
                                            @if($user->google_id)
                                                Connected
                                            @else
